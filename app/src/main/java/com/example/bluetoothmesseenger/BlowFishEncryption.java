...
public class BlowFishEncryption {
    private static final String[][] S = { { "d1310ba6", "98dfb5ac", "2ffd72db", "d01adfb7", "b8e1afed",
    ...
    public static String P[] = { "243f6a88", "85a308d3", "13198a2e", "03707344", "a4093822",
    ...
    private static String hexToBin(String plainText)
    {
        String binary = "";
        Long num;
        String binary4B;
    ...
    @RequiresApi(api = Build.VERSION_CODES.O)
    private static String binToHex(String plainText)
    {
    ...
    @RequiresApi(api = Build.VERSION_CODES.O)
    public static String BlowFishEncryptionCall(String str)
    {
